...
if (isset($_POST['KEY_USER_ID']) && isset($_POST['$KEY_USER_USERNAME']) && isset($_POST['$KEY_USER_NAME']) && isset($_POST['KEY_USER_CONTACTNUM']) && isset($_POST['KEY_USER_EMAIL'])&& isset($_POST['KEY_CAR_MAKE']) && isset($_POST['KEY_CAR_MODEL']) && isset($_POST['KEY_CAR_PLATE'])&& isset($_POST['KEY_REGISTERDATE']) && isset($_POST['KEY_USER_ACCOUNTTYPE']) && isset($_POST['KEY_USER_PASSWORD'])) {
	...
	$sql ="INSERT INTO course(KEY_USER_ID, KEY_USER_USERNAME, KEY_USER_NAME, KEY_USER_CONTACTNUM, KEY_USER_EMAIL, KEY_CAR_MAKE, KEY_CAR_MODEL, KEY_CAR_PLATE, KEY_REGISTERDATE, KEY_USER_ACCOUNTTYPE, KEY_USER_PASSWORD) VALUES('$KEY_USER_ID', '$KEY_USER_USERNAME', '$KEY_USER_NAME', '$KEY_USER_CONTACTNUM', '$credit', '$KEY_USER_EMAIL', '$KEY_CAR_MAKE', '$KEY_CAR_MODEL', '$KEY_CAR_PLATE', '$KEY_REGISTERDATE', '$KEY_USER_ACCOUNTTYPE', 'KEY_USER_PASSWORD')";
