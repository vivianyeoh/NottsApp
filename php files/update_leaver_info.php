...
if (isset($_POST['KEY_L_ID']) && isset($_POST['KEY_L_USER_ID']) && isset($_POST['KEY_L_LOCATION']) && isset($_POST['KEY_L_DESC']) && isset($_POST['KEY_L_PARINGSTATUS']) && isset($_POST['KEY_L_NOWOFAFTER10']) && isset($_POST['KEY_L_DATE']) && isset($_POST['KEY_L_TIME'])) {
	...
	$sql = "UPDATE TABLE_LEAVER SET KEY_L_USER_ID='$KEY_L_USER_ID', KEY_L_LOCATION = '$KEY_L_LOCATION', KEY_L_DESC = '$KEY_L_DESC', KEY_L_PARINGSTATUS = '$KEY_L_PARINGSTATUS', KEY_L_NOWOFAFTER10 = '$KEY_L_NOWOFAFTER10', KEY_L_DATE = '$KEY_L_DATE' , KEY_L_TIME = '$KEY_L_TIME' WHERE KEY_L_ID='$KEY_L_ID'";
