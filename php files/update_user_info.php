...
if (isset($_POST['KEY_USER_ID']) && isset($_POST['$KEY_USER_USERNAME']) && isset($_POST['$KEY_USER_NAME']) && isset($_POST['KEY_USER_CONTACTNUM']) && isset($_POST['KEY_USER_EMAIL']) && isset($_POST['KEY_CAR']) && isset($_POST['KEY_REGISTERDATE']) && isset($_POST['KEY_USER_ACCOUNTTYPE']) && isset($_POST['KEY_USER_PASSWORD'])) {
	...
	$sql = "UPDATE TABLE_CAR SET KEY_USER_USERNAME='$KEY_USER_USERNAME', KEY_USER_NAME = '$KEY_USER_NAME', KEY_USER_CONTACTNUM = '$KEY_USER_CONTACTNUM', KEY_USER_EMAIL = '$KEY_USER_EMAIL', KEY_CAR = '$KEY_CAR' , KEY_REGISTERDATE = '$KEY_REGISTERDATE', KEY_USER_ACCOUNTTYPE = '$KEY_USER_ACCOUNTTYPE' , KEY_USER_PASSWORD = '$KEY_USER_PASSWORD' WHERE KEY_USER_ID='$KEY_USER_ID'";
